<div class="sce_form__content">
  ...
  <div class="sce_application_cell">
    ...
    ><input type="text" id="sce_mname" name="mname" placeholder="Middle name" />
  </div>
  <div class="sce_application_cell">
  ...
  <div class="sce_application_cell">
    <label>Contry <span>*</span></label
    ><select name="country" id="sce_country" required>
  ...
  <div class="sce_application_cell">
    <label>Post code/Pincode <span>*</span></label
    ><input
      type="text"
      id="sce_postcode"
      name="postcode"
      placeholder="Post code/Pincode"
      required
    />
  </div>
  <div class="sce_application_cell">
    ...
    <div class="flex_row">
      <div class="flex_row__left">
        <select name="phone_code" id="sce_phone_code" required>
